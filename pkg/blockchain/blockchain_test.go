...
func ExampleBlockchainExtension() {
	...
	transaction1 := Transaction{bobPublicKeyString, alicePublicKeyString, time.Now(), message1Data, Nonce()}
	blockChain.AddTransaction(transaction1)
	transaction2 := Transaction{alicePublicKeyString, bobPublicKeyString, time.Now(), message2Data, Nonce()}
	...
	transaction3 := Transaction{bobPublicKeyString, alicePublicKeyString, time.Now(), message3Data, Nonce()}
	...
	transaction4 := Transaction{alicePublicKeyString, bobPublicKeyString, time.Now(), message4Data, Nonce()}
